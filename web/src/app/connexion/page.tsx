        ...
        <div className="w-full max-w-md space-y-6">
            ...
            >
              <div className="text-center space-y-1">
                ...
                <p className="text-xs text-ink-soft">
                  Saisissez les 6 chiffres du code — démo : <strong>123456</strong>
                </p>
              </div>
          ...
          <div className="text-center">
            <button
              ...
              className="text-xs font-medium text-ink-soft hover:text-terracotta underline underline-offset-4"
            >
