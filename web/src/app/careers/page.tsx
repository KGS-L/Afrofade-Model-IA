...
export default function CareersPage(){return <div className="min-h-screen bg-cream text-ink"><Navbar/><Suspense fallback={<main className="min-h-[60vh]"/>}><CareersMarketplace/></Suspense><Footer/></div>}
